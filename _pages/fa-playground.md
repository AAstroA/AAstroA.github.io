...
eyebrow: "آزمایشگاه تعاملی مالیه"
description: "مفاهیم مالیه کمی را در مرورگر تجربه کنید. ابزارها برای آموزش، آزمون فرض‌ها و ساختن شهود طراحی شده‌اند و به نصب نرم‌افزار یا سرور نیاز ندارند."
...
<section class="playground-roadmap" data-reveal>
  ...
  <div class="roadmap-grid">
    ...
    <article><span>برنامه‌ریزی‌شده</span><h3>آزمایشگاه مالیه شبکه‌ای</h3><p>نمایش انتشار، مرکزیت و انتقال شوک در شبکه‌های مالی.</p></article>
  </div>
</section>
